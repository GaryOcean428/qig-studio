...
PINS (verified latest-published 2026-07-23; NOT the local dev builds):
  qig-core==2.15.2  (the cradle APIs: separation_distress, consciousness.ResonanceBank, check_drift P3 fix
...
image = (
    ...
    .run_commands(
        ...
        "'torch>=2.2.0' "
        "'qig-core==2.15.2' 'qig-warp==0.6.9' 'qig-compute==0.9.8' "
...
def train(steps: int = 10000, fresh: bool = False):
    ...
    cmd = [
        ...
        "--qig-core-pin", "2.15.2",             # E3 parity: fail closed unless installed qig-core == 2.15.2
        "--seed", "1234",
        "--steps", str(steps),
    ]
    if fresh:
